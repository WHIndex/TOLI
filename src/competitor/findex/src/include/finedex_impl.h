...
// =================== search the data =======================
template<class key_t, class val_t>
inline result_f FINEdex<key_t, val_t>::find(const key_t &key, val_t &val)
{   
...
// =================== insert the data =======================
template<class key_t, class val_t>
inline result_f FINEdex<key_t, val_t>::insert(
...
// ================ update =================
template<class key_t, class val_t>
inline result_f FINEdex<key_t, val_t>::update(
        const key_t& key, const val_t& val)
{
...
// ==================== remove =====================
template<class key_t, class val_t>
inline result_f FINEdex<key_t, val_t>::remove(const key_t& key)
{
